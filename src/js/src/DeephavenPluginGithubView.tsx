...
const log = Log.module('deephaven-plugin-github.DeephavenPluginGithubView');

// Create a custom style for the component
export const DeephavenPluginGithubViewStyle: CSSProperties = {
...
export function DeephavenPluginGithubView(props: WidgetComponentProps): JSX.Element {
  const { fetch } = props;
  ...
  return (
    <div style={DeephavenPluginGithubViewStyle}>
      <div>{text}</div>
...
export default DeephavenPluginGithubView;
